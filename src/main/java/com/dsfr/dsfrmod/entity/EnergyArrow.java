...
public abstract class EnergyArrow extends Projectile {
    private static final double ARROW_BASE_DAMAGE = 2.0D;
    private static final EntityDataAccessor<Byte> ID_FLAGS = SynchedEntityData.defineId(EnergyArrow.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> PIERCE_LEVEL = SynchedEntityData.defineId(EnergyArrow.class, EntityDataSerializers.BYTE);
...
//    public int shakeTime;
    ...
    protected EnergyArrow(EntityType<? extends EnergyArrow> p_37248_, Level p_37249_) {
        super(p_37248_, p_37249_);
    }

    protected EnergyArrow(EntityType<? extends EnergyArrow> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_) {
        this(p_36711_, p_36715_);
        this.setPos(p_36712_, p_36713_, p_36714_);
    }

    protected EnergyArrow(EntityType<? extends EnergyArrow> p_36717_, LivingEntity p_36718_, Level p_36719_) {
...
//        }
        ...
        if (this.inGround && !flag) {
            ...
            while(!this.isRemoved()) {
                ...
                if (hitresult != null && hitresult.getType() == HitResult.Type.ENTITY) {
                    ...
                    if (entity instanceof AreaEffectCloud && entity instanceof Player && entity1 instanceof Player && !((Player)entity1).canHarmPlayer((Player)entity)) {
                        hitresult = null;
    ...
    protected void onHitEntity(EntityHitResult p_36757_) {
        ...
        if (entity1 == null) {
            damagesource = damagesources.source(DamageTypes.ARROW, this, this);
        } else {
            damagesource = damagesources.source(DamageTypes.ARROW, this, entity1);
...
//        this.shakeTime = 7;
    ...
    protected void onHit(HitResult p_36913_){
        ...
        if (!this.level().isClientSide) {
            ...
            if(p_36913_.getType() == HitResult.Type.ENTITY){
                areaeffectcloud = new AreaEffectCloud(this.level(), p_36913_.getLocation().x(), p_36913_.getLocation().y(), p_36913_.getLocation().z());
            }else{
                areaeffectcloud = new AreaEffectCloud(this.level(), this.getX(), this.getY(), this.getZ());
            }
            ...
            areaeffectcloud.addEffect(getEffect());
            if (!list.isEmpty()) {
            ...
            if(p_36913_.getType() == HitResult.Type.BLOCK){
                this.discard();
            }
        }
    ...
    protected abstract MobEffectInstance getEffect();
...
//        CREATIVE_ONLY;
//
//        public static EnergyArrow.Pickup byOrdinal(int p_36809_) {
