...
@OnlyIn(Dist.CLIENT)
public abstract class EnergyArrowRenderer<T extends EnergyArrow> extends EntityRenderer<T> {
    public EnergyArrowRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }
